...
- [ ] 1.6.3 `move`-closure captures · `&T`/`&mut T` exclusivity beyond single calls (a live `&mut` forbids other borrows); reborrow rules
- [ ] 1.6.4 Lifetimes: a reference may not outlive its referent (reject returning/storing a borrow of a local)
